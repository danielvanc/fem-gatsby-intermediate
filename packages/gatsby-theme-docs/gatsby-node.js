...
// node = node that was created, the actions we can do with the node, load the node, helper to create node id
exports.onCreateNode = ({ node, actions, getNode, createNodeId }, options) => {
  ...
  if (
    node.internal.type !== 'Mdx' || parent.sourceInstanceName !== 'gatsby-theme-docs'
  ) {
    return;
  }
  // Treat 'index.mdx' link `index.html` (.ie `docs/ vs docs/index)
